...
t::check "NVMe crypto -> NVMe Crypto Purge" '[[ ${devrow[d1.method]} == "NVMe Crypto Purge" ]]'
...
type[d1]="HDD"
device::classify d1
t::check "ATA clear HDD -> CLEAR" '[[ ${devrow[d1.class]} == "CLEAR" ]]'
t::check "ATA clear HDD -> ATA Secure Erase" '[[ ${devrow[d1.method]} == "ATA Secure Erase" ]]'
